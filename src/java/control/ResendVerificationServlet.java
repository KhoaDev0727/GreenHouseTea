...
public class ResendVerificationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String body = "<html>"
                ...
                + "</div>"
                + "<p>Dear " + fullName + ",</p>"
                + "<p>You requested a new verification code to log into your account at GreenHouse Tea. Please use the verification code below to complete your login process:</p>"
