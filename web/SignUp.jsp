<%-- 
    Document   : SignUp
    Created on : Oct 11, 2024, 2:34:00 PM
    Author     : le minh khoa
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <section class="signup">
            <div class="container-signup position-relative">
                <div class="back-btn">
                ...
                <div class="signup-content">
                        ...
                        <form action="RegisterServlet" method="post" class="register-form" id="register-form">                               
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" id="fullname" placeholder="Your Full Name" 
                                       value="<%= request.getAttribute("fullnameValue") != null ? request.getAttribute("fullnameValue") : "" %>" 
                                       />
                    ...
                    <div class="signup-image">
                        ...
                        <a href="SignIn.jsp" class="signup-image-link">Already have an account?</a>
                    </div>
                </div>
            </div>
        </section>
